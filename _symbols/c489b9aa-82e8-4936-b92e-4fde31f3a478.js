...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t0 = claim_text(h30_nodes, /*content_title*/ ctx[0]);
			...
			t5 = claim_text(h31_nodes, /*content_title*/ ctx[0]);
			...
			t16 = claim_text(p5_nodes, /*content_paragraph_3*/ ctx[5]);
		...
		h() {
			...
			attr(div8, "class", "section-container content svelte-1yi48le");
			attr(div9, "class", "wrapper svelte-1yi48le");
			attr(div10, "class", "container none svelte-1yi48le");
			attr(div10, "id", "contact-us");
		},
		m(target, anchor) {
