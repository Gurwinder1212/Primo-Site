// Site Header - Home - Updated August 20, 2024
function noop() { }
function run(fn) {
    return fn();
}
...
// (583:12) {#each hero_feature as feature }
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			attr(h6, "class", "h700 svelte-uzahmm");
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h10, "class", "svelte-uzahmm");
			attr(div0, "class", "hero-text-container1 svelte-uzahmm");
			attr(h11, "class", "svelte-uzahmm");
			attr(div1, "class", "hero-text-container2 svelte-uzahmm");
			attr(div2, "class", "hero-feature-tag-container tags_top svelte-uzahmm");
			attr(p, "class", "h650 svelte-uzahmm");
			attr(div3, "class", "hero-feature-container svelte-uzahmm");
			...
			set_custom_element_data(lottie_player, "class", "hero-lottie svelte-uzahmm");
			...
			attr(img0, "class", "hero-image svelte-uzahmm");
			...
			attr(div4, "class", "svelte-uzahmm");
			attr(div5, "class", "hero-image-wrapper svelte-uzahmm");
			attr(img1, "class", "home-banner-mobile svelte-uzahmm");
			...
			attr(img2, "class", "home-banner-small-desktop svelte-uzahmm");
			...
			attr(div6, "class", "header-wrapper svelte-uzahmm");
			attr(div7, "class", "header-container svelte-uzahmm");
			attr(section, "role", "img");
			attr(section, "aria-label", section_aria_label_value = /*background*/ ctx[0].alt);
			attr(section, "class", "svelte-uzahmm");
		},
		m(target, anchor) {
